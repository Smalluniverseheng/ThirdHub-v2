...
**仍 📋 未做（按派发规则排队）**：
- 阅读：R-1 统计 / R-2 换源 / R-3 批注 / R-5 漫画双页 / R-6 书架批量 / R-7 追更 / R-10 摘抄
- 影音：M-4 统一最近播放 / M-5 投屏 DLNA / M-6 下载归一
- 浏览器：B-1 阅读模式 / B-2 网页翻译 / B-3 隐私模式 / B-4 长截图 / B-5 书签同步 / B-7~B-9（UA/手势/夜间）
