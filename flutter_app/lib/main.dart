...
const kChangelog = [
  ('v4.19.0', '小模块做实第7-9批(共8个): 通讯录备份(导出/恢复JSON) / 短信备份(导出+验证码提取) / 扫描仪(拍照灰度增强) / 有声书(本地连播) / 短剧(竖屏连播) / 文件互传(局域网扫码秒传) / 家庭影院(本地视频库) / 家庭音乐库(本地音乐+随机播放); 短信读取改为自研通道(原 telephony 插件已无人维护且不兼容新构建链)'),
