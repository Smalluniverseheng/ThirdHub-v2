...
class I18n extends ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> dict = _mergeExtra({
    'en': {
      ...
      '主题': 'Theme',
      '预览: 卡片、按钮、进度条都会使用强调色': 'Preview: cards, buttons and progress bars all use the accent color',
      '固定保留': 'Always kept',
      '登录账号': 'Sign-in account',
      '· 前后端自动配对(局域网 / IPv6 / 内网穿透三路竞速)\n· 书架、阅读进度云端同步\n· 远程(外出)也能连家里的资源库': '· Front/back-end auto-pairing (LAN / IPv6 / tunnel — three paths, raced)\n· Shelf and reading progress synced to cloud\n· Reach your home library when away',
      '游客模式': 'Guest mode',
      '不登录也能用: 本地播放 + 局域网内手动连接/自动发现资源库。\n云端同步与远程连接需登录后解锁。': 'Usable without signing in: local playback + manual connect / auto-discovery on the LAN.\nCloud sync and remote access unlock after signing in.',
      '以游客身份进入': 'Continue as guest',
      '上一步': 'Back',
      '确认资源库指纹': 'Confirm library fingerprint',
      '信任': 'Trust',
      '外观': 'Appearance',
      '云端': 'Cloud',
      '系统': 'System',
      '个性化': 'Personalization',
      '低端机模式': 'Low-end mode',
      '压缩过渡动画、加大列表分帧步长、降低图片缓存；功能一个不少': 'Compress transitions, widen list frame steps, shrink image cache — no feature is lost',
      '关于': 'About',
    },
    'ja': {
      ...
      // ★2026-09-25 补：此前这些键连 en 都缺，任何语言都落回中文原文
      '主题': 'テーマ',
      '预览: 卡片、按钮、进度条都会使用强调色': 'プレビュー: カード・ボタン・進捗バーはすべてアクセントカラーを使用',
      '固定保留': '常に保持',
      '登录账号': 'ログインアカウント',
      '· 前后端自动配对(局域网 / IPv6 / 内网穿透三路竞速)\n· 书架、阅读进度云端同步\n· 远程(外出)也能连家里的资源库': '・フロント/バックエンドの自動ペアリング(LAN / IPv6 / トンネルの3経路競争)\n・本棚と読書進捗をクラウド同期\n・外出先からも自宅のライブラリに接続',
      '游客模式': 'ゲストモード',
      '不登录也能用: 本地播放 + 局域网内手动连接/自动发现资源库。\n云端同步与远程连接需登录后解锁。': 'ログインなしで利用可: ローカル再生 + LAN内の手動接続/自動検出。\nクラウド同期とリモート接続はログイン後に解放。',
      '以游客身份进入': 'ゲストとして続行',
      '上一步': '戻る',
      '确认资源库指纹': 'ライブラリの指紋を確認',
      '信任': '信頼する',
      ...
      '个性化': 'パーソナライズ',
      '低端机模式': '低スペック端末モード',
      '压缩过渡动画、加大列表分帧步长、降低图片缓存；功能一个不少': 'トランジションを圧縮し、リストの分割ステップを拡大、画像キャッシュを削減。機能はそのまま',
      '关于': 'このアプリについて',
      '强调色': 'アクセントカラー',
      '跳过': 'スキップ',
      '密码错误': '暗証番号が違います',
      ...
      '已关闭': 'オフ',
      '已开启': 'オン',
      '设置PIN(4-6位)': 'PINを設定(4〜6桁)',
      '网盘': 'クラウドディスク',
      '待机': '待機中',
      '故障': 'エラー',
      '网络引擎(局域网设备)': 'ネットワークエンジン(LAN機器)',
      '已添加下载': 'ダウンロードを追加しました',
      '存储服务': 'ストレージサービス',
      '暂无任务': 'タスクなし',
      '选照片同步': '写真を選んで同期',
      ...
      '开屏动画': '起動アニメーション',
      '导航': 'ナビゲーション',
      '悬浮球默认位置': 'フローティングボールの既定位置',
      '左侧': '左',
      '右侧': '右',
      '贤者模式（内容保护）': 'セージモード(コンテンツ保護)',
      '清理缓存': 'キャッシュを削除',
      '版本与更新': 'バージョンと更新',
      '云存储': 'クラウドストレージ',
      '会员等级': '会員ランク',
